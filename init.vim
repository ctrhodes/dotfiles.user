...
nmap <leader>p "+p
nmap <leader>P "+P
" OS like cut/copy using output of Option+<key>
...
let g:airline_section_c = '%F'                        " show relative path in status line
let g:airline#extensions#tabline#buffer_nr_show = 1   " add buffer number to buffer/tab line for easy switching
...
" After starting vim, run following:
...
" ----------------------------------------------------------------------------
" https://ro-che.info/articles/2017-04-03-disable-weird-indentation-rstats-vim
